(function(h,p){function x(){}function F(a){return a}function D(){return(new Date).getTime()}function M(a,b){return a===b}function T(a,b){return a-b}function J(a){return a.toString()}function z(a){throw a;}function E(){if(this.isDisposed)throw Error(ia);}function N(a,b){return 1===a.length&&Array.isArray(a[b])?a[b]:B.call(a)}function U(a,b){for(var c=Array(a),e=0;e<a;e++)c[e]=b();return c}function O(a,b){this.scheduler=a;this.disposable=b;this.isDisposed=!1}function n(a,b,c,e,j){this.scheduler=a;this.state=
b;this.action=c;this.dueTime=e;this.comparer=j||T;this.disposable=new v}function K(a,b){var c=this;return new r(function(e){var j=0,t=a.length;return c.subscribe(function(c){if(j<t){var g=a[j++],d;try{d=b(c,g)}catch(f){e.onError(f);return}e.onNext(d)}else e.onCompleted()},e.onError.bind(e),e.onCompleted.bind(e))})}var H="object"==typeof exports&&exports&&("object"==typeof global&&global&&global==global.global&&(h=global),exports),q={Internals:{}},ia="Object has been disposed";Function.prototype.bind||
(Function.prototype.bind=function(a){var b=this,c=B.call(arguments,1),e=function(){if(this instanceof e){var j=function(){};j.prototype=b.prototype;var j=new j,t=b.apply(j,c.concat(B.call(arguments)));return Object(t)===t?t:j}return b.apply(a,c.concat(B.call(arguments)))};return e});var B=Array.prototype.slice,$={}.hasOwnProperty,C=q.Internals.inherits=function(a,b){function c(){this.constructor=a}for(var e in b)"prototype"!==e&&$.call(b,e)&&(a[e]=b[e]);c.prototype=b.prototype;a.prototype=new c;a.super_=
b.prototype;return a},P=q.Internals.addProperties=function(a){for(var b=B.call(arguments,1),c=0,e=b.length;c<e;c++){var j=b[c],t;for(t in j)a[t]=j[t]}},oa=q.Internals.addRef=function(a,b){return new r(function(c){return new g(b.getDisposable(),a.subscribe(c))})};Array.prototype.every||(Array.prototype.every=function(a,b){for(var c=Object(this),e=0,j=c.length>>>0;e<j;e++)if(e in c&&!a.call(b,c[e],e,c))return!1;return!0});Array.prototype.map||(Array.prototype.map=function(a,b){for(var c=j.length>>>
...
null};u.prototype.getDisposable=function(){return this.current};u.prototype.setDisposable=function(a){var b=this.isDisposed,c;b||(c=this.current,this.current=a);c&&c.dispose();b&&a&&a.dispose()};u.prototype.disposable=function(a){if(a)this.setDisposable(a);else return this.getDisposable()};u.prototype.dispose=function(){var a;this.isDisposed||(this.isDisposed=!0,a=this.current,this.current=null);a&&a.dispose()};var I=function(a){this.disposable=a;this.disposable.count++;this.isInnerDisposed=!1},w=
function(a){this.underlyingDisposable=a;this.isPrimaryDisposed=this.isDisposed=!1;this.count=0};I.prototype.dispose=function(){!this.disposable.isDisposed&&!this.isInnerDisposed&&(this.isInnerDisposed=!0,this.disposable.count--,0===this.disposable.count&&this.disposable.isPrimaryDisposed&&(this.disposable.isDisposed=!0,this.disposable.underlyingDisposable.dispose()))};w.prototype.dispose=function(){!this.isDisposed&&!this.isPrimaryDisposed&&(this.isPrimaryDisposed=!0,0===this.count&&(this.isDisposed=
!0,this.underlyingDisposable.dispose()))};w.prototype.getDisposable=function(){return this.isDisposed?m:new I(this)};var Fa=q.RefCountDisposable=w;O.prototype.dispose=function(){var a=this;this.scheduler.schedule(function(){a.isDisposed||(a.isDisposed=!0,a.disposable.dispose())})};n.prototype.invoke=function(){this.disposable.disposable(this.invokeCore())};n.prototype.compareTo=function(a){return this.comparer(this.dueTime,a.dueTime)};n.prototype.isCancelled=function(){return this.disposable.isDisposed};
n.prototype.invokeCore=function(){return this.action(this.scheduler,this.state)};var Q=function(a,b,c,e){this.now=a;this._schedule=b;this._scheduleRelative=c;this._scheduleAbsolute=e},Ga=function(a,b,c){var e=b.first,j=b.second,t=new g,d=function(b){j(b,function(b,e){var j=!1,g=!1,f=a[c].call(a,b,e,function(a,b){j?t.remove(f):g=!0;d(b);return m});g||(t.add(f),j=!0)})};d(e);return t},pa=function(a,b){b();return m},G=Q.prototype;G.catchException=function(a){return new Ha(this,a)};G.schedulePeriodic=
function(a,b){return this.schedulePeriodicWithState(null,a,function(){b()})};G.schedulePeriodicWithState=function(a,b,c){var e=a,j=h.setInterval(function(){e=c(e)},b);return y(function(){h.clearInterval(j)})};G.schedule=function(a){return this._schedule(a,pa)};G.scheduleWithState=function(a,b){return this._schedule(a,b)};G.scheduleWithRelative=function(a,b){return this._scheduleRelative(b,a,pa)};G.scheduleWithRelativeAndState=function(a,b,c){return this._scheduleRelative(a,b,c)};G.scheduleWithAbsolute=
...
null==a?0:a,b||T)};C(ka,q.VirtualTimeScheduler);var sa=ka.prototype;sa.add=function(a,b){return a+b};sa.toDateTimeOffset=function(a){return(new Date(a)).getTime()};sa.toRelative=function(a){return a};q.HistoricalScheduler=ka;var La,Ma=h.requestAnimationFrame||h.webkitRequestAnimationFrame||h.mozRequestAnimationFrame||h.oRequestAnimationFrame||h.msRequestAnimationFrame,gb=h.cancelAnimationFrame||h.webkitCancelAnimationFrame||h.mozCancelAnimationFrame||h.oCancelAnimationFrame||h.msCancelAnimationFrame,
fa,ga;"undefined"!==typeof h.process&&"function"===typeof h.process.nextTick?(fa=h.process.nextTick,ga=x):"function"===typeof h.setImmediate?(fa=h.setImmediate,ga=h.clearImmediate):"function"===typeof Ma?(fa=Ma,ga=gb):(fa=function(a){return h.setTimeout(a,0)},ga=h.clearTimeout);La=new L(D,function(a,b){var c=this,e=new v,j=fa(function(){e.setDisposable(b(c,a))});return new g(e,y(function(){ga(j)}))},function(a,b,c){var e=this;b=L.normalize(b);if(0===b)return e.scheduleWithState(a,c);var j=new v,t=
h.setTimeout(function(){j.setDisposable(c(e,a))},b);return new g(j,y(function(){h.clearTimeout(t)}))},function(a,b,c){return this.scheduleWithRelativeAndState(a,b-this.now(),c)});var hb=L.timeout=La,Ha,ib=function(){return this._scheduler.now()},jb=function(a,b){return this._scheduler.scheduleWithState(a,this._wrap(b))},kb=function(a,b,c){return this._scheduler.scheduleWithRelativeAndState(a,b,this._wrap(c))},lb=function(a,b,c){return this._scheduler.scheduleWithAbsoluteAndState(a,b,this._wrap(c))},
Z=function(a,b){this._scheduler=a;this._handler=b;this._recursiveWrapper=this._recursiveOriginal=null;Z.super_.constructor.call(this,ib,jb,kb,lb)};C(Z,L);Z.prototype._clone=function(a){return new Z(a,this._handler)};Z.prototype._wrap=function(a){var b=this;return function(c,e){try{return a(b._getRecursiveWrapper(c),e)}catch(j){if(!b._handler(j))throw j;return m}}};Z.prototype._getRecursiveWrapper=function(a){if(!this._recursiveOriginal!==a){this._recursiveOriginal=a;var b=this._clone(a);b._recursiveOriginal=
a;this._recursiveWrapper=b._recursiveWrapper=b}return this._recursiveWrapper};Z.prototype.schedulePeriodicWithState=function(a,b,c){var e=this,j=!1,t=new v;t.setDisposable(this._scheduler.schedulePeriodicWithState(a,b,function(a){if(j)return null;try{return c(a)}catch(b){j=!0;if(!e._handler(b))throw b;t.dispose();return null}}));return t};Ha=Z;var Na=function(){};P(Na.prototype,{accept:function(a,b,c){return 1<arguments.length||"function"===typeof a?this._accept(a,b,c):this._acceptObservable(a)},
toObservable:function(a){var b=this;a=a||R;return new r(function(c){return a.schedule(function(){b._acceptObservable(c);if("N"===b.kind)c.onCompleted()})})},hasValue:!1,equals:function(a){return this.toString()===(null==a?"":a.toString())}});var ca=q.Notification=Na,ta=function(a){this.value=a;this.hasValue=!0;this.kind="N"};C(ta,ca);P(ta.prototype,{_accept:function(a){return a(this.value)},_acceptObservable:function(a){return a.onNext(this.value)},toString:function(){return"OnNext("+this.value+")"}});
var Oa=ca.createOnNext=function(a){return new ta(a)},ua=function(a){this.exception=a;this.kind="E"};C(ua,ca);P(ua.prototype,{_accept:function(a,b){return b(this.exception)},_acceptObservable:function(a){return a.onError(this.exception)},toString:function(){return"OnError("+this.exception+")"}});var Pa=ca.createOnError=function(a){return new ua(a)},va=function(){this.kind="C"};C(va,ca);P(va.prototype,{_accept:function(a,b,c){return c()},_acceptObservable:function(a){return a.onCompleted()},toString:function(){return"OnCompleted()"}});
var Qa=ca.createOnCompleted=function(){return new va},Ra=q.Internals.Enumerator=function(a,b,c){this.moveNext=a;this.getCurrent=b;this.dispose=c},Sa=Ra.create=function(a,b,c){var e=!1;c||(c=x);return new Ra(function(){if(e)return!1;var b=a();b||(e=!0,c());return b},function(){return b()},function(){e||(c(),e=!0)})},mb=q.Internals,wa=function(a){this.getEnumerator=a};wa.prototype.concat=function(){var a=this;return new r(function(b){var c=a.getEnumerator(),e=!1,j=new u,t=R.scheduleRecursive(function(a){var t,
g,d=!1;if(!e){try{(d=c.moveNext())?t=c.getCurrent():c.dispose()}catch(f){g=f,c.dispose()}if(g)b.onError(g);else if(d)g=new v,j.setDisposable(g),g.setDisposable(t.subscribe(b.onNext.bind(b),b.onError.bind(b),function(){a()}));else b.onCompleted()}});return new g(j,t,y(function(){e=!0;c.dispose()}))})};wa.prototype.catchException=function(){var a=this;return new r(function(b){var c=a.getEnumerator(),e=!1,j,t=new u,d=R.scheduleRecursive(function(a){var g,d,f;f=!1;if(!e){try{(f=c.moveNext())&&(g=c.getCurrent())}catch(k){d=
k}if(d)b.onError(d);else if(f)d=new v,t.setDisposable(d),d.setDisposable(g.subscribe(b.onNext.bind(b),function(b){j=b;a()},b.onCompleted.bind(b)));else if(j)b.onError(j);else b.onCompleted()}});return new g(t,d,y(function(){e=!0}))})};var la=mb.Enumerable=wa,Ta=la.repeat=function(a,b){b===p&&(b=-1);return new la(function(){var c,e=b;return Sa(function(){if(0===e)return!1;0<e&&e--;c=a;return!0},function(){return c})})},xa=la.forEach=function(a,b){b||(b=F);return new la(function(){var c,e=-1;return Sa(function(){return++e<
a.length?(c=b(a[e],e),!0):!1},function(){return c})})},S=q.Observer=function(){};S.prototype.toNotifier=function(){var a=this;return function(b){return b.accept(a)}};S.prototype.asObserver=function(){return new ya(this.onNext.bind(this),this.onError.bind(this),this.onCompleted.bind(this))};S.prototype.checked=function(){return new Ua(this)};var nb=S.create=function(a,b,c){a||(a=x);b||(b=z);c||(c=x);return new ya(a,b,c)};S.fromNotifier=function(a){return new ya(function(b){return a(Oa(b))},function(b){return a(Pa(b))},
function(){return a(Qa())})};var ob=q.Internals,aa=function(){this.isStopped=!1};C(aa,S);aa.prototype.onNext=function(a){this.isStopped||this.next(a)};aa.prototype.onError=function(a){this.isStopped||(this.isStopped=!0,this.error(a))};aa.prototype.onCompleted=function(){this.isStopped||(this.isStopped=!0,this.completed())};aa.prototype.dispose=function(){this.isStopped=!0};aa.prototype.fail=function(){return!this.isStopped?(this.isStopped=!0,this.error(!0),!0):!1};var za=ob.AbstractObserver=aa,da=
function(a,b,c){da.super_.constructor.call(this);this._onNext=a;this._onError=b;this._onCompleted=c};C(da,za);da.prototype.next=function(a){this._onNext(a)};da.prototype.error=function(a){this._onError(a)};da.prototype.completed=function(){this._onCompleted()};var ya=q.AnonymousObserver=da,Ua,ea=function(a){this._observer=a;this._state=0};C(ea,S);ea.prototype.onNext=function(a){this.checkAccess();try{this._observer.onNext(a)}finally{this._state=0}};ea.prototype.onError=function(a){this.checkAccess();
try{this._observer.onError(a)}finally{this._state=2}};ea.prototype.onCompleted=function(){this.checkAccess();try{this._observer.onCompleted()}finally{this._state=2}};ea.prototype.checkAccess=function(){if(1===this._state)throw Error("Re-entrancy detected");if(2===this._state)throw Error("Observer completed");0===this._state&&(this._state=1)};Ua=ea;var pb=q.Internals,W=function(a,b){W.super_.constructor.call(this);this.scheduler=a;this.observer=b;this.hasFaulted=this.isAcquired=!1;this.queue=[];this.disposable=
new u};C(W,za);W.prototype.next=function(a){var b=this;this.queue.push(function(){b.observer.onNext(a)})};W.prototype.error=function(a){var b=this;this.queue.push(function(){b.observer.onError(a)})};W.prototype.completed=function(){var a=this;this.queue.push(function(){a.observer.onCompleted()})};W.prototype.ensureActive=function(){var a=!1,b=this;!this.hasFaulted&&0<this.queue.length&&(a=!this.isAcquired,this.isAcquired=!0);a&&this.disposable.setDisposable(this.scheduler.scheduleRecursive(function(a){var e;
if(0<b.queue.length){e=b.queue.shift();try{e()}catch(j){throw b.queue=[],b.hasFaulted=!0,j;}a()}else b.isAcquired=!1}))};W.prototype.dispose=function(){W.super_.dispose.call(this);this.disposable.dispose()};var qb=pb.ScheduledObserver=W,Va,X=function(){X.super_.constructor.apply(this,arguments)};C(X,qb);X.prototype.next=function(a){X.super_.next.call(this,a);this.ensureActive()};X.prototype.error=function(a){X.super_.error.call(this,a);this.ensureActive()};X.prototype.completed=function(){X.super_.completed.call(this);
this.ensureActive()};Va=X;var s,Wa=function(a){this._subscribe=a};s=Wa.prototype;s.finalValue=function(){var a=this;return new r(function(b){var c=!1,e;return a.subscribe(function(a){c=!0;e=a},b.onError.bind(b),function(){if(c)b.onNext(e),b.onCompleted();else b.onError(Error("Sequence contains no elements."))})})};s.subscribe=function(a,b,c){var e;e=0===arguments.length||1<arguments.length||"function"===typeof a?nb(a,b,c):a;return this._subscribe(e)};s.toArray=function(){return this.scan([],function(a,
b){a.push(b);return a.slice(0)}).startWith([]).finalValue()};var A=q.Observable=Wa;A.start=function(a,b){return rb(a,b)()};var rb=A.toAsync=function(a,b,c){b||(b=hb);return function(){var e=B.call(arguments,0),j=new sb;b.schedule(function(){var b;try{b=a.apply(c,e)}catch(g){j.onError(g);return}j.onNext(b);j.onCompleted()});return j.asObservable()}};s.observeOn=function(a){var b=this;return new r(function(c){return b.subscribe(new Va(a,c))})};s.subscribeOn=function(a){var b=this;return new r(function(c){var e=
new v,j=new u;j.setDisposable(e);e.setDisposable(a.schedule(function(){j.setDisposable(new O(a,b.subscribe(c)))}));return j})};A.create=function(a){return new r(function(b){return y(a(b))})};A.createWithDisposable=function(a){return new r(a)};var tb=A.defer=function(a){return new r(function(b){var c;try{c=a()}catch(e){return Xa(e).subscribe(b)}return c.subscribe(b)})},ub=A.empty=function(a){a||(a=R);return new r(function(b){return a.schedule(function(){b.onCompleted()})})},Aa=A.fromArray=function(a,
b){b||(b=ba);return new r(function(c){var e=0;return b.scheduleRecursive(function(b){if(e<a.length)c.onNext(a[e++]),b();else c.onCompleted()})})};A.generate=function(a,b,c,e,j){j||(j=ba);return new r(function(t){var g=!0,d=a;return j.scheduleRecursive(function(a){var j,f;try{g?g=!1:d=c(d),(j=b(d))&&(f=e(d))}catch(k){t.onError(k);return}if(j)t.onNext(f),a();else t.onCompleted()})})};var Ya=A.never=function(){return new r(function(){return m})};A.range=function(a,b,c){c||(c=ba);return new r(function(e){return c.scheduleRecursiveWithState(0,
function(c,t){if(c<b)e.onNext(a+c),t(c+1);else e.onCompleted()})})};A.repeat=function(a,b,c){c||(c=ba);b==p&&(b=-1);return vb(a,c).repeat(b)};var vb=A.returnValue=function(a,b){b||(b=R);return new r(function(c){return b.schedule(function(){c.onNext(a);c.onCompleted()})})},Xa=A.throwException=function(a,b){b||(b=R);return new r(function(c){return b.schedule(function(){c.onError(a)})})};A.using=function(a,b){return new r(function(c){var e=m,j,t;try{(j=a())&&(e=j),t=b(j)}catch(d){return new g(Xa(d).subscribe(c),
...
function(){j=!0;if(!c)b.onCompleted()});return new g(f,e)})};s.takeUntil=function(a){var b=this;return new r(function(c){return new g(b.subscribe(c),a.subscribe(c.onCompleted.bind(c),c.onError.bind(c),x))})};s.zip=function(){if(Array.isArray(arguments[0]))return K.apply(this,arguments);var a=this,b=B.call(arguments),c=b.pop();b.unshift(a);return new r(function(e){for(var j=b.length,d=U(j,function(){return[]}),f=U(j,function(){return!1}),k=Array(j),m=0;m<j;m++)(function(j){k[j]=new v;k[j].setDisposable(b[j].subscribe(function(b){d[j].push(b);
...
{},m=new g,l=new Fa(m);m.add(d.subscribe(function(d){var j,g,y,h,u,w,I,s,r;try{g=a(d),w=e(g)}catch(Q){for(r in k)k[r].onError(Q);f.onError(Q);return}u=!1;try{s=k[w],s||(s=new Za,k[w]=s,u=!0)}catch(q){for(r in k)k[r].onError(q);f.onError(q);return}if(u){u=new Ba(g,s,l);g=new Ba(g,s);try{j=c(g)}catch(n){for(r in k)k[r].onError(n);f.onError(n);return}f.onNext(u);I=new v;m.add(I);h=function(){w in k&&(delete k[w],s.onCompleted());m.remove(I)};I.setDisposable(j.take(1).subscribe(x,function(a){for(r in k)k[r].onError(a);
f.onError(a)},function(){h()}))}try{y=b(d)}catch(p){for(r in k)k[r].onError(p);f.onError(p);return}s.onNext(y)},function(a){for(var b in k)k[b].onError(a);f.onError(a)},function(){for(var a in k)k[a].onCompleted();f.onCompleted()}));return l})};s.select=s.map=function(a){var b=this;return new r(function(c){var e=0;return b.subscribe(function(b){var d;try{d=a(b,e++)}catch(g){c.onError(g);return}c.onNext(d)},c.onError.bind(c),c.onCompleted.bind(c))})};s.selectMany=s.flatMap=function(a,b){return b?this.selectMany(function(c){return a(c).select(function(a){return b(c,
...
s.where=s.filter=function(a){var b=this;return new r(function(c){var e=0;return b.subscribe(function(b){var d;try{d=a(b,e++)}catch(g){c.onError(g);return}if(d)c.onNext(b)},c.onError.bind(c),c.onCompleted.bind(c))})};var Bb=q.Internals,Ca=function(a){Ca.super_.constructor.call(this,function(b){var c=new $a(b);if(ba.scheduleRequired())ba.schedule(function(){try{c.disposable(a(c))}catch(b){if(!c.fail(b))throw b;}});else try{c.disposable(a(c))}catch(e){if(!c.fail(e))throw e;}return c})};C(Ca,A);var r=
Bb.AnonymousObservable=Ca,$a,Y=function(a){Y.super_.constructor.call(this);this.observer=a;this.m=new v};C(Y,za);Y.prototype.next=function(a){var b=!1;try{this.observer.onNext(a),b=!0}finally{b||this.dispose()}};Y.prototype.error=function(a){try{this.observer.onError(a)}finally{this.dispose()}};Y.prototype.completed=function(){try{this.observer.onCompleted()}finally{this.dispose()}};Y.prototype.disposable=function(a){return this.m.disposable(a)};Y.prototype.dispose=function(){Y.super_.dispose.call(this);
this.m.dispose()};$a=Y;var Ba,Cb=function(a){return this.underlyingObservable.subscribe(a)},Da=function(a,b,c){Da.super_.constructor.call(this,Cb);this.key=a;this.underlyingObservable=!c?b:new r(function(a){return new g(c.getDisposable(),b.subscribe(a))})};C(Da,A);Ba=Da;var Ea=function(a,b){this.subject=a;this.observer=b};Ea.prototype.dispose=function(){if(!this.subject.isDisposed&&null!==this.observer){var a=this.subject.observers.indexOf(this.observer);this.subject.observers.splice(a,1);this.observer=
null}};var Db=function(a){E.call(this);if(!this.isStopped)return this.observers.push(a),new Ea(this,a);if(this.exception)return a.onError(this.exception),m;a.onCompleted();return m},ha=function(){ha.super_.constructor.call(this,Db);this.isStopped=this.isDisposed=!1;this.observers=[]};C(ha,A);P(ha.prototype,S,{onCompleted:function(){E.call(this);if(!this.isStopped){var a=this.observers.slice(0);this.isStopped=!0;for(var b=0,c=a.length;b<c;b++)a[b].onCompleted();this.observers=[]}},onError:function(a){E.call(this);
...
b){na.super_.constructor.call(this,Fb);this.observer=a;this.observable=b};C(na,A);P(na.prototype,S,{onCompleted:function(){this.observer.onCompleted()},onError:function(a){this.observer.onError(a)},onNext:function(a){this.observer.onNext(a)}});ab=na;if("function"==typeof define&&"object"==typeof define.amd&&define.amd)return h.Rx=q,define("rx",[],function(){return q});H?"object"==typeof module&&module&&module.exports==H?module.exports=q:H=q:h.Rx=q})(this);
(function(h,p){var x="object"==typeof exports&&exports&&("object"==typeof h&&h&&h==h.global&&(window=h),exports);"function"===typeof define&&define.amd?define("rx.time",["rx","exports"],function(x,D){h.Rx=p(h,D,x);return h.Rx}):"object"==typeof module&&module&&module.exports==x?module.exports=p(h,module.exports,require("./rx")):h.Rx=p(h,{},h.Rx)})(this,function(h,p,x,F){function D(l,d,f){var g=C(d);return new z(function(d){var y=0,m=l;return f.scheduleRecursiveWithAbsolute(m,function(l){var u;0<g&&
(u=f.now(),m+=g,m<=u&&(m=u+g));d.onNext(y++);l(m)})})}function M(l,d,f){return l===d?new z(function(g){return f.schedulePeriodicWithState(0,d,function(d){g.onNext(d);return d+1})}):E(function(){return D(f.now()+l,d,f)})}function T(l,d){var f=this;return new z(function(g){var k=!1,y=new H,m=null,v=[],u=!1,h;h=f.materialize().timestamp(d).subscribe(function(f){"E"===f.value.kind?(v=[],v.push(f),m=f.value.exception,f=!u):(v.push({value:f.value,timestamp:f.timestamp+l}),f=!k,k=!0);if(f)if(null!==m)g.onError(m);
else f=new K,y.disposable(f),f.disposable(d.scheduleRecursiveWithRelative(l,function(f){var l,y,h;if(null===m){u=!0;do l=null,0<v.length&&0>=v[0].timestamp-d.now()&&(l=v.shift().value),null!==l&&l.accept(g);while(null!==l);h=!1;y=0;0<v.length?(h=!0,y=Math.max(0,v[0].timestamp-d.now())):k=!1;l=m;u=!1;if(null!==l)g.onError(l);else h&&f(y)}}))});return new q(h,y)})}function J(l,d){return new z(function(f){function g(){m&&(m=!1,f.onNext(y));if(k)f.onCompleted()}var k,y,m;return new q(l.subscribe(function(d){m=
!0;y=d},f.onError.bind(f),function(){k=!0}),d.subscribe(g,f.onError.bind(f),g))})}h=x.Observable;p=h.prototype;var z=x.Internals.AnonymousObservable,E=h.defer,N=h.empty,U=h.throwException,O=h.fromArray,n=x.Scheduler.timeout,K=x.SingleAssignmentDisposable,H=x.SerialDisposable,q=x.CompositeDisposable,ia=x.RefCountDisposable,B=x.Subject,$=x.Internals.addRef,C=x.Scheduler.normalize,P=h.interval=function(l,d){d||(d=n);return M(l,l,d)},oa=h.timer=function(l,d,f){var g;f||(f=n);d!==F&&"number"===typeof d?
g=d:d!==F&&"object"===typeof d&&(f=d);if(l instanceof Date&&g===F){var k=l.getTime(),y=f;return new z(function(d){return y.scheduleWithAbsolute(k,function(){d.onNext(0);d.onCompleted()})})}if(l instanceof Date&&g!==F)return D(l.getTime(),d,f);if(g===F){var m=f,h=C(l);return new z(function(d){return m.scheduleWithRelative(h,function(){d.onNext(0);d.onCompleted()})})}return M(l,g,f)};p.delay=function(l,d){d||(d=n);var f;if(l instanceof Date){var g=l.getTime(),k=d,y=this;f=E(function(){var d=g-k.now();
return T.call(y,d,k)})}else f=T.call(this,l,d);return f};p.throttle=function(l,d){d||(d=n);var f=this;return new z(function(g){var k=new H,y=!1,m=0,h,u=null;h=f.subscribe(function(f){var h;y=!0;u=f;m++;h=m;f=new K;k.disposable(f);f.disposable(d.scheduleWithRelative(l,function(){if(y&&m===h)g.onNext(u);y=!1}))},function(d){k.dispose();g.onError(d);y=!1;m++},function(){k.dispose();if(y)g.onNext(u);g.onCompleted();y=!1;m++});return new q(h,k)})};p.windowWithTime=function(l,d,f){var g=this,k;d===F&&(k=
l);f===F&&(f=n);"number"===typeof d?k=d:"object"===typeof d&&(k=l,f=d);return new z(function(d){var m,h,u=k,I=l,w=[],n,Q=new H,p=0;h=new q(Q);n=new ia(h);m=function(){var g,l,h,v,q;h=new K;Q.disposable(h);g=l=!1;I===u?g=l=!0:I<u?l=!0:g=!0;v=l?I:u;q=v-p;p=v;l&&(I+=k);g&&(u+=k);h.disposable(f.scheduleWithRelative(q,function(){var f;g&&(f=new B,w.push(f),d.onNext($(f,n)));l&&(f=w.shift(),f.onCompleted());m()}))};w.push(new B);d.onNext($(w[0],n));m();h.add(g.subscribe(function(d){var f,g;for(f=0;f<w.length;f++)g=
w[f],g.onNext(d)},function(f){var g,k;for(g=0;g<w.length;g++)k=w[g],k.onError(f);d.onError(f)},function(){var f,g;for(f=0;f<w.length;f++)g=w[f],g.onCompleted();d.onCompleted()}));return n})};p.windowWithTimeOrCount=function(l,d,f){var g=this;f||(f=n);return new z(function(k){var h,m,v=0,u,n,w=new H,p=0;m=new q(w);u=new ia(m);h=function(d){var g=new K;w.disposable(g);g.disposable(f.scheduleWithRelative(l,function(){var f;d===p&&(v=0,f=++p,n.onCompleted(),n=new B,k.onNext($(n,u)),h(f))}))};n=new B;
k.onNext($(n,u));h(0);m.add(g.subscribe(function(f){var g=0,l=!1;n.onNext(f);v++;v===d&&(l=!0,v=0,g=++p,n.onCompleted(),n=new B,k.onNext($(n,u)));l&&h(g)},function(d){n.onError(d);k.onError(d)},function(){n.onCompleted();k.onCompleted()}));return u})};p.bufferWithTime=function(l,d,f){var g;d===F&&(g=l);f||(f=n);"number"===typeof d?g=d:"object"===typeof d&&(g=l,f=d);return this.windowWithTime(l,g,f).selectMany(function(d){return d.toArray()})};p.bufferWithTimeOrCount=function(l,d,f){f||(f=n);return this.windowWithTimeOrCount(l,
d,f).selectMany(function(d){return d.toArray()})};p.timeInterval=function(l){var d=this;l||(l=n);return E(function(){var f=l.now();return d.select(function(d){var k=l.now(),h=k-f;f=k;return{value:d,interval:h}})})};p.timestamp=function(l){l||(l=n);return this.select(function(d){return{value:d,timestamp:l.now()}})};p.sample=function(l,d){d||(d=n);return"number"===typeof l?J(this,P(l,d)):J(this,l)};p.timeout=function(l,d,f){var g,k=this;d||(d=U(Error("Timeout")));f||(f=n);g=l instanceof Date?function(d,
g){f.scheduleWithAbsolute(d,g)}:function(d,g){f.scheduleWithRelative(d,g)};return new z(function(f){var m,h=0,u=new K,n=new H,w=!1,p=new H;n.disposable(u);m=function(){var k=h;p.disposable(g(l,function(){(w=h===k)&&n.disposable(d.subscribe(f))}))};m();u.disposable(k.subscribe(function(d){w||(h++,f.onNext(d),m())},function(d){w||(h++,f.onError(d))},function(){w||(h++,f.onCompleted())}));return new q(n,p)})};h.generateWithAbsoluteTime=function(l,d,f,g,k,h){h||(h=n);return new z(function(m){var n=!0,
u=!1,p,w=l,q;return h.scheduleRecursiveWithAbsolute(h.now(),function(l){if(u)m.onNext(p);try{if(n?n=!1:w=f(w),u=d(w))p=g(w),q=k(w)}catch(h){m.onError(h);return}if(u)l(q);else m.onCompleted()})})};h.generateWithRelativeTime=function(l,d,f,g,k,h){h||(h=n);return new z(function(m){var n=!0,u=!1,p,q=l,O;return h.scheduleRecursiveWithRelative(0,function(l){if(u)m.onNext(p);try{if(n?n=!1:q=f(q),u=d(q))p=g(q),O=k(q)}catch(h){m.onError(h);return}if(u)l(O);else m.onCompleted()})})};p.delaySubscription=function(l,
d){d||(d=n);return this.delayWithSelector(oa(l,d),function(){return N()})};p.delayWithSelector=function(l,d){var f=this,g,k;"function"===typeof l?k=l:(g=l,k=d);return new z(function(d){var l=new q,h=!1,n=function(){if(h&&0===l.length)d.onCompleted()},p=new H,w=function(){p.setDisposable(f.subscribe(function(f){var g;try{g=k(f)}catch(h){d.onError(h);return}var p=new K;l.add(p);p.setDisposable(g.subscribe(function(){d.onNext(f);l.remove(p);n()},d.onError.bind(d),function(){d.onNext(f);l.remove(p);n()}))},
d.onError.bind(d),function(){h=!0;p.dispose();n()}))};g?p.setDisposable(g.subscribe(function(){w()},d.onError.bind(onError),function(){w()})):w();return new q(p,l)})};p.timeoutWithSelector=function(l,d,f){l||(l=observableNever());f||(f=U(Error("Timeout")));var g=this;return new z(function(k){var h=new H,m=new H,n=new K;h.setDisposable(n);var p=0,O=function(d){var g=p,l=new K;m.setDisposable(l);l.setDisposable(d.subscribe(function(){p===g&&h.setDisposable(f.subscribe(k));l.dispose()},function(d){if(p===
g)k.onError(d)},function(){p===g&&h.setDisposable(f.subscribe(k))}))};O(l);var w=function(){p++;return!0};n.setDisposable(g.subscribe(function(f){if(w()){k.onNext(f);var g;try{g=d(f)}catch(l){k.onError(l);return}O(g)}},function(d){if(w())k.onError(d)},function(){if(w())k.onCompleted()}));return new q(h,m)})};p.throttleWithSelector=function(l){var d=this;return new z(function(f){var g,k=!1,h=new H,m=0,n=d.subscribe(function(d){var n;try{n=l(d)}catch(p){f.onError(p);return}k=!0;g=d;m++;var q=m,v=new K;
h.setDisposable(v);v.setDisposable(n.subscribe(function(){if(k&&m===q)f.onNext(g);k=!1;v.dispose()},f.onError.bind(f),function(){if(k&&m===q)f.onNext(g);k=!1;v.dispose()}))},function(d){h.dispose();f.onError(d);k=!1;m++},function(){h.dispose();if(k)f.onNext(g);f.onCompleted();k=!1;m++});return new q(n,h)})};p.skipLastWithTime=function(l,d){d||(d=n);var f=this;return new z(function(g){var k=[];return f.subscribe(function(f){var h=d.now();for(k.push({interval:h,value:f});0<k.length&&h-k[0].interval>=
l;)g.onNext(k.shift().value)},g.onError.bind(g),function(){for(var f=d.now();0<k.length&&f-k[0].interval>=l;)g.onNext(k.shift().value);g.onCompleted()})})};p.takeLastWithTime=function(h,d,f){return this.takeLastBufferWithTime(h,d).selectMany(function(d){return O(d,f)})};p.takeLastBufferWithTime=function(h,d){var f=this;d||(d=n);return new z(function(g){var k=[];return f.subscribe(function(f){var g=d.now();for(k.push({interval:g,value:f});0<k.length&&g-k[0].interval>=h;)k.shift()},g.onError.bind(g),
function(){for(var f=d.now(),m=[];0<k.length;){var n=k.shift();f-n.interval<=h&&m.push(n.value)}g.onNext(m);g.onCompleted()})})};p.takeWithTime=function(h,d){var f=this;d||(d=n);return new z(function(g){var k=d.scheduleWithRelative(h,function(){g.onCompleted()});return new q(k,f.subscribe(g))})};p.skipWithTime=function(h,d){var f=this;d||(d=n);return new z(function(g){var k=!1,n=d.scheduleWithRelative(h,function(){k=!0}),m=f.subscribe(function(d){if(k)g.onNext(d)},g.onError.bind(g),g.onCompleted.bind(g));
return new q(n,m)})};p.skipUntilWithTime=function(h,d){d||(d=n);var f=this;return new z(function(g){var k=!1,n=d.scheduleWithAbsolute(h,function(){k=!0}),m=f.subscribe(function(d){if(k)g.onNext(d)},g.onError.bind(g),g.onCompleted.bind(g));return new q(n,m)})};p.takeUntilWithTime=function(h,d){d||(d=n);var f=this;return new z(function(g){return new q(d.scheduleWithAbsolute(h,function(){g.onCompleted()}),f.subscribe(g))})};return x});
(function(h,p){"function"===typeof define&&define.amd?define("jsFrames",["rx.time"],function(x){return p(h,x)}):h.jsFrames=p(h,h.Rx)})(this,function(h,p){function x(h){requestAnimationFrame(x);for(var n=0;n<T.length;n++)T[n](h);E+=(h-N-E)/z;N=h}for(var F=0,D=["ms","moz","webkit","o"],M=0;M<D.length&&!h.requestAnimationFrame;++M)h.requestAnimationFrame=h[D[M]+"RequestAnimationFrame"],h.cancelAnimationFrame=h[D[M]+"CancelAnimationFrame"]||h[D[M]+"CancelRequestAnimationFrame"];h.requestAnimationFrame||
(h.requestAnimationFrame=function(p){var n=(new Date).getTime(),x=Math.max(0,16-(n-F)),z=h.setTimeout(function(){p(n+x)},x);F=n+x;return z});h.cancelAnimationFrame||(h.cancelAnimationFrame=function(h){clearTimeout(h)});var T=[],J=[],z=20,E=0,N=0,U=p.Observable.interval(1E3).select(function(){return(1E3/E).toFixed()}).distinctUntilChanged(),D=function(h,n,p){this.gravity=0.06;this.alpha=1;this.fade=0.1*Math.random();this.position={x:h.x||0,y:h.y||0};this.velocity={x:n.x||0,y:n.y||0};this.color=p;this.lastPosition=
{x:this.position.x,y:this.position.y}};D.prototype.update=function(){this.lastPosition.x=this.position.x;this.lastPosition.y=this.position.y;this.velocity.y+=this.gravity;this.position.x+=this.velocity.x;this.position.y+=this.velocity.y;this.alpha-=this.fade};D.prototype.postUpdate=function(){};D.prototype.render=function(h){h.save();h.globalAlpha=this.alpha;h.strokeStyle=this.color;h.beginPath();h.moveTo(this.lastPosition.x,this.lastPosition.y);h.lineTo(this.position.x,this.position.y);h.stroke();
h.restore()};return{registerAnimation:function(h){T.push(h)},start:function(){requestAnimationFrame(x)},onFpsUpdate:function(h){U.subscribe(h)},Particle:D,addParticle:function(h){J.push(h)},removeParticle:function(h){J.splice(J.indexOf(h),1)},renderParticles:function(h){for(var n=J.length;n--;){var p=J[n];p.update();p.postUpdate();p.render(h)}}}});"function"===typeof define&&define.amd&&define("jsFrames.min",["jsFrames"],function(h){return h});
