...
function(b){clearTimeout(b)})})();window.jsFrames=function(c,a){function b(a){requestAnimationFrame(b);for(var c=0;c<f.length;c++)f[c](a);d+=(a-e-d)/g;e=a}var f=[],g=20,d=0,e=0;a.registerAnimation=function(a){f.push(a)};a.start=function(){e=Date.now();b(e);return e};a.fpsStream=c.Observable.interval(1E3).select(function(){return(1E3/d).toFixed()}).distinctUntilChanged();return a}(window.Rx,window.jsFrames||{});
